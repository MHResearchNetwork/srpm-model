...
sink("PC_sd_90_logfile.txt", split=TRUE)
...
write.csv(lambda.results, "PC_sd_90_Lambdas_m5.csv")
save(model.list, file="PC_sd_90_model_list_m5.RData")
save(final.model, file="PC_sd_90_final_model_m5.RData")
