...
sink("MH_sr_90_logfile.txt", split=TRUE)
...
write.csv(lambda.results, "MH_sr_90_Lambdas_m5.csv")
save(model.list, file="MH_sr_90_model_list_m5.RData")
save(final.model, file="MH_sr_90_final_model_m5.RData")
